export const IMAGES = {
  ...
  servicos1: new URL('../04-assets/images/nossos-servicos.jpg', import.meta.url)
    .href,
  servicos2: new URL(
  ...
  diferenciais: new URL('../04-assets/images/diferenciais.jpg', import.meta.url)
    .href,
  quemSomos: new URL('../04-assets/images/quem-somos.jpg', import.meta.url)
    .href,
